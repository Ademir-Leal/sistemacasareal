 ...
 <div class="container">
   ...
   <div class="row single-top">
							 ...
							 <div class="col-md-3 ">
							   <ul class="blog-list">
								  <h4> Opções </h4>
								  <li><a href="financeiro.php"> Finanças do Centro de Apoio</a></li>
								  <li><a href="#"> Finanças por Artesão </a></li>
								</ul>
				              </div>
				              ...
				              <div class="col-md-9">
				                <div class="login-page">
				                     <div class="login-title">
	           		                   <h4 class="title"> Detalhes Financeiros </h4>
					                      <div id="loginbox" class="loginbox">
						                    <fieldset class="input">
												<form name="busca" action="financeiro.php" method="post"  id="busca" enctype="multipart/form-data" >
						  
													<p id="login-form-username">
													  <label for="modlgn_username"> Email: </label>
													  <input id="end_eletronico" type="email" name="end_eletronico" class="inputbox" size="17" >
													</p>
													<p id="login-form-username">
													...
													<p id="login-form-username">
													  <label for="modlgn_username"> Período de Faturamento (Início): </label>
...
<?php				       
	...
	if(isset($_REQUEST['end_eletronico']) && (isset($_REQUEST['data'])) && (isset($_REQUEST['artesao']))){			       
			
			$end_eletronico = $_POST['end_eletronico'];
